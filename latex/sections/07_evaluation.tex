...
\end{align}
% TODO: Cite a standard reference for regression metrics and the interpretation of R^2.
...
\end{equation*}
The noise is applied after resampling but before velocity and acceleration channels are computed and before saved clean-data standardization factors are applied. Thus, $\sigma$ is expressed in metres, and derivative-based models also receive derivatives of the noisy positions.
% TODO: Cite a numerical-analysis reference on the amplification of measurement noise by differentiation.
